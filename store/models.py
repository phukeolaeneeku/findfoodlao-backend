...
class GoodsModel(models.Model):
    class Meta:
        ...
        ordering = ['category__name']  # เพิ่มการเรียงลำดับตามชื่อหมวดหมู่
...
class BankAccount(models.Model):
    ...
    image1 = models.FileField(
        null=True, blank=True, verbose_name="image1", upload_to="media/"
    )
    image2 = models.FileField(
        null=True, blank=True, verbose_name="image2", upload_to="media/"
    )
